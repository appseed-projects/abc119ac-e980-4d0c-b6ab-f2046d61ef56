...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-07 08:52`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/abc119ac-e980-4d0c-b6ab-f2046d61ef56.git
$ cd abc119ac-e980-4d0c-b6ab-f2046d61ef56
```
